...
void readDistance() {
  ...
  distance[0] = (0.93 * distance[0] + 0.07 * distanceOld[0]);//- 13; //53; //61;
  distance[1] = (0.93 * distance[1] + 0.07 * distanceOld[1])-2;//- 17; //20
  distance[2] = ( 0.93 * distance[2] + 0.07 * distanceOld[2]) - 55; // - 60;//40;
