...
void readDistance() {
  ...
  distance[0] = (0.93 * distance[0] + 0.07 * distanceOld[0]) - 13; //- 55; //61; //calibrated these need to be verified...
  distance[1] = (0.93 * distance[1] + 0.07 * distanceOld[1]) - 20; // - 20;
  distance[2] = ( 0.93 * distance[2] + 0.07 * distanceOld[2]) - 60; //- 40;
