...
#define flagAddress 0x0801F3EE
#define pathAddress 0x0801F3ED
...
void setup() {
  ...
  //  endFlag =  * (uint8_t *) flagAddress ;
  //  if (endFlag == 555) {
  //    path =  * (uint8_t *) pathAddress ;
  //    for (int i = 0; i < path; i++) {
  //      eeprom.readByte(shortPath[i]);
  //      Serial.println(shortPath[i]);
  //      if (shortPath[i] == 'Z') {
  //        break;
  //      }
  //    }
