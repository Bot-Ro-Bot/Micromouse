...
void loop() {
  //Serial.print("  Yaw from filter:"  );   Serial.print(yaw);  Serial.print("  Yaw from mag:"); Serial.print(magYaw);  Serial.print("  Yaw from gyro:");  Serial.println(gyroYaw);
  //distance[0] = sensorFront.readRangeSingleMillimeters();
  //Serial.println(distance[0]);  Serial.print("\t");
  //    delay(1000);
  //    left();
  //    delay(1000);
  leftMotor->forward(50 );
