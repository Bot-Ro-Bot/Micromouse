...
bool VL53L0X::init(bool io_2v8) {
  ...
  Serial.println("Initialization begAN2");
  ...
  Serial.println("Initialization begAN3");
  ...
  Serial.println("Initialization begAN4");
  uint8_t spad_count = 0;
  bool spad_type_is_aperture = 0;

  if (!getSpadInfo(&spad_count, &spad_type_is_aperture)) {

    return false;
  }
  Serial.println("Initialization begAN5");
...
bool VL53L0X::getSpadInfo(uint8_t * count, bool * type_is_aperture)
{
  ...
  Serial.println("Initialization SPID bhitra 1");
  ...
  Serial.println("Initialization SPID bhitra 2");
